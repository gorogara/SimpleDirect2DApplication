...
HRESULT DemoApp::CreateDeviceIndependentResources()
{
	...
	if (SUCCEEDED(hr))
	{
		hr = m_pDirect2dFactory->CreateEllipseGeometry(
...
HRESULT DemoApp::OnRender()
{
	...
	if (SUCCEEDED(hr))
	{
		...
		const D2D1::Matrix3x2F scale = D2D1::Matrix3x2F::Scale(
			D2D1::SizeF(zoom, zoom), D2D1::Point2F(x, y));

		m_pRenderTarget->SetTransform(rot * trans * scale);

		m_pRenderTarget->DrawGeometry(m_pEllipseGeometry, m_pLightSlateGrayBrush, 3.0f, m_pStrokeStyle);
		...
		//// Draw rectangle
		//m_pRenderTarget->DrawLine(
		//	D2D1::Point2F(rtSize.width / 2 - 100.0f, rtSize.height / 2 - 100.0f),
		//	D2D1::Point2F(rtSize.width / 2 + 100.0f, rtSize.height / 2 - 100.0f),
		//	m_pLightSlateGrayBrush,
		//	strokeWidth,
		//	m_pStrokeStyle);
		...
		//// Draw line above rectangle
		//m_pRenderTarget->DrawLine(
		//	D2D1::Point2F(30.0f, rtSize.height / 2 - 140.0f),
		//	D2D1::Point2F(rtSize.width - 30.0f, rtSize.height / 2 - 140.0f),
		//	m_pLightSlateGrayBrush,
		//	strokeWidth,
		//	m_pStrokeStyle);
